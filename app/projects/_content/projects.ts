const projects = [
  ...
  {
    heading: "AI Sudoku Solver Competition - Python",
    bulletPoints: [
      ...
      "Used backtracking with constraint propagation to solve the Sudoku.",
      "Solved most Sudokus that were 10% full under 10ms.",
      "Used human solving techniques in the constraints, making my algorithm over 1000 times more efficient.",
    ],
  },
  {
    heading: "Parallel Processing & Multithreading Competition - C, Azure",
    bulletPoints: [
  ...
  {
    heading: "Student Study Scheduler (C#, SQL & .NET Framework)",
    bulletPoints: [
      ...
      "Designed an appealing GUI in .NET & used SQL commands in C# to manage the user's data/progress.",
      "Effectively documented and accommodated my stakeholder’s requirements.",
    ],
  },
  {
    heading: "Encryption Using Spectral Analysis (Java)",
    bulletPoints: [
      "Incorporated asymmetric encryption by converting strings into a time-varying signals, applied signal and image processing techniques with the JDSP and OpenCV library to convert data into an image object.",
      "Incorporated asymmetric encryption by converting strings into analogue signals.",
      "Applied signal processing techniques to convert a time-varying signal into a picture.",
      "Converted this picture into a string and decrypted the message using image processing techniques.",
    ],
  },
  {
    heading: "Projectile Interception Camera (Python)",
    bulletPoints: [
  ...
  {
    heading:
      "Microprocessor Digital Lock and Stopwatch - PICKIT 3 (Assembly & C)",
    bulletPoints: [
      "Decomposed the functionality into modular assignments to suit an agile environment.",
      "Interpreted datasheets, wired keypad, speaker and LCD display correctly, and mapped inputs/outputs.",
  ...
  },
  {
    ...
    bulletPoints: [
      ...
      "Assessed the completeness of my team’s work with server tests and I conducted continuity tests.",
    ],
  },
  {
    heading: "CPU Design with VGA Output on an ALU (SystemVerilog HDL)",
    bulletPoints: [
  ...
  {
    heading: "Video Compression and Picture Processing (MATLAB)",
    bulletPoints: [
  ...
  {
    heading:
      "PCB Design, CAD & Electrical Experience (Cadence OrCAD & Allegro)",
    bulletPoints: [
  ...
  {
    heading: "Analogue Circuit Simulator Algorithm - SPICE (Python)",
    bulletPoints: [
      "Created a design document and thoroughly described/implemented the various testing strategies.",
      "Successfully works with combinations of resistors/capacitor/inductors with different frequencies.",
